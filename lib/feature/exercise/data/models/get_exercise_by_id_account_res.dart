class GetExerciseByIdAccountResponse {
  bool? success;
  int? statusCode;
  Meta? meta;
  List<GetExerciseByIdAccountData>? data;

  GetExerciseByIdAccountResponse(
      {this.success, this.statusCode, this.meta, this.data});

  GetExerciseByIdAccountResponse.fromJson(Map<String, dynamic> json) {
...
class GetExerciseByIdAccountData {
  int? iId;
  int? idTeacher;
  String? idCourse;
  String? nameCourse;
