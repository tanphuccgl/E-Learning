...
abstract class GetGradeExerciseRemoteDataSource {
  Future<GetGradeExerciseResponse> getGradeExercise(int idExercise,String idCourse    );
}

class GetGradeExerciseRemoteDataSourceImpl implements GetGradeExerciseRemoteDataSource {
  ...
  Future<GetGradeExerciseResponse> _getGradeExercise(int idExercise ,String idCourse  ) async {
    final response = await client?.get(
      Uri.parse('$mainUrl/exercise/GetGradeExercise?idCourse=$idCourse&idExercise=$idExercise'),
      headers: {
    ...
    log("Get GetGradeExercise: " + "$mainUrl/exercise/GetGradeExercise?idCourse=$idCourse&idExercise=$idExercise");
