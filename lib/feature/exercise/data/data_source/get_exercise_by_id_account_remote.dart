...
class GetExerciseByIdAccountRemoteDataSourceImpl implements GetExerciseByIdAccountRemoteDataSource {
  ...
  Future<GetExerciseByIdAccountResponse> _getExerciseByIdAccount(int idAccount ) async {
    ...
    log("Get GetExerciseByIdAccount: " + "$mainUrl/exercise/GetExerciseByIdAccount/$idAccount");
