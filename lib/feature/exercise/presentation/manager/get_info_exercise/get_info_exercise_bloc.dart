...
class GetInfoExerciseBloc extends Bloc<GetInfoExerciseEvent, GetInfoExerciseState> {
  ...
  @override
  Stream<GetInfoExerciseState> mapEventToState(GetInfoExerciseEvent event) async* {
