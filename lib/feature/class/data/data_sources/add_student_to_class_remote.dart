...
Future<bool> addStudentToClass({int? idClass , int? idStudent ,Function? success,Function? failure}) async {
  var body = jsonEncode({'idClass': idClass, 'idStudent': idStudent ,});
  final response =
