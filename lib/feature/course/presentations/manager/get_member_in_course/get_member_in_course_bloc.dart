...
class GetMemberInCourseBloc
    extends Bloc<GetMemberInCourseEvent, GetMemberInCourseState> {
  ...
  @override
  Stream<GetMemberInCourseState> mapEventToState(
      GetMemberInCourseEvent event) async* {
    if (event is GetMemberInCourseEventE) {
      yield Loading();
      final failureOrSuccess = await getMemberInCourse(GetMemberInCourseParams(
          idCourse: event.idCourse, keySearchName: event.keySearchName));
