...
class GetAllLectureRemoteDataSourceImpl
    implements GetAllLectureRemoteDataSource {
  ...
  Future<GetAllLectureResponse> _getAllLecture(
    ...
    final response = await client!.get(
      Uri.parse('$mainUrl/lecture/GetAllLectureOfCourse?idCourse=$idCourse'),
      headers: {
    ...
    log("Get GetAllLectureResponse: " + '${response.statusCode}');
